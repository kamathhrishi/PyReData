...
#Import required libraries , which would be dependencies needed to be installed prior to using the module
...
class App:
       ...
       def __init__(self,Name,Stylesheet="",Template=""):
...
class Page:
        ...
        def __init__(self,app,Name,style=""):
...
class Plots:
            ...
            def RenderPlot(self,Plot,Div="",height=300,width=300,Type=""):
                  ...
                  fileName=("Plots/"+str((self.Page.PlotNames))+'.png')
...
class Stylesheet:
           ...
           def CreateStyleSheet(self,Name=""):

                  util=Utilities(self.Source)
                  Link=None
                  if(Name=="" and self.Page.Sheet==None):
                      
                       Link=util.GenerateFile(self.Source,"Stylesheet","css")
                       
                  else:
                      
                       Link=util.GenerateFile(self.Source,Name,"css")
...
class Utilities:
        ...
        def GenerateFile(self,Source,Name,Type):
